...
#| label: tbl-summary
#| tbl-cap: Summary of the target samples dataset
...
#| label: fig-heatmap
#| fig-heatmap: "Hierarchically clustered heatmap of the pairwise Pearson’s correlation coefficients between the time series of allele frequencies in the case study."
...
![**Figure 11.** Time series of dN and dS. Each point corresponds to a different sample, sorted in chronological order.](`r params$evo`){#fig-evo}
